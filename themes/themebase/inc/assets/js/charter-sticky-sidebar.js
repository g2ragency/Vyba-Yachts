document.addEventListener("DOMContentLoaded", function () {
  const sidebar = document.querySelector(".charter-sidebar");
  if (!sidebar) return;

  const sidebarInner = sidebar.querySelector(".charter-sidebar-inner");
  const mainContent = document.querySelector(".charter-main-content");
  const gallery = document.querySelector(".charter-gallery-section");
